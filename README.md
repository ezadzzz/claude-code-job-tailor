...
| `@agent-tailor-generate-resume`                                        | Agent   | Generate tailored resume using existing job analysis data (requires metadata and job_analysis files)                                                           |
| `/cover-letter company-name`                                           | Skill   | Interactive cover letter co-authoring with company research, achievement interviewing, and Cultivated Culture framework                                        |
